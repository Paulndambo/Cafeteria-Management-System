...
from apps.orders.views import (add_cart_items, add_to_cart, clear_order_items,
                               clear_shopping_cart, confirm_order,
                               confirm_overpaid_order, customer_order,
                               ...
                               place_customer_cash_order,
                               place_customer_mpesa_order, pos, pos_home,
                               print_order_receipt,
